...
//Name: shack.ma
//Last modified: Fri, Feb 28, 2014 10:25:42 AM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.55003155072979248 1.6644353673380865 15.841484795426121 ;
	setAttr ".r" -type "double3" -2.1383527292732891 0.20000000015099301 7.8427241191289659e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.85968292082265;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "/Users/pdburgess86/3D-Essentials//sourceimages/3dPaintTextures/shack/pCubeShape1_color.iff";
createNode place2dTexture -n "place2dTexture1";
createNode lambert -n "ShackMaterial";
createNode shadingEngine -n "lambert2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file2";
	setAttr ".ftn" -type "string" "/Users/pdburgess86/3D-Essentials//sourceimages/3dPaintTextures/shack/pCubeShape1_color_1.iff";
...
connectAttr "file2.oc" "ShackMaterial.c";
connectAttr "ShackMaterial.oc" "lambert2SG.ss";
connectAttr "pCubeShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "ShackMaterial.msg" "materialInfo1.m";
...
connectAttr "ShackMaterial.msg" ":defaultShaderList1.s" -na;
